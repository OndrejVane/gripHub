...
import { sampleWithRequiredData } from '../boulder.test-samples';
import { BoulderService } from '../service/boulder.service';

import { BoulderComponent } from './boulder.component';
import SpyInstance = jest.SpyInstance;

describe('Boulder Management Component', () => {
  let comp: BoulderComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(BoulderComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.boulders()[0]).toEqual(expect.objectContaining({ id: 24244 }));
  });

  describe('trackId', () => {
    it('should forward to boulderService', () => {
      const entity = { id: 24244 };
      jest.spyOn(service, 'getBoulderIdentifier');
      const id = comp.trackId(entity);
      expect(service.getBoulderIdentifier).toHaveBeenCalledWith(entity);
