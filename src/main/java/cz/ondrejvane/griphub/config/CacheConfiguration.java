...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, cz.ondrejvane.griphub.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, cz.ondrejvane.griphub.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, cz.ondrejvane.griphub.domain.User.class.getName());
            ...
            createCache(cm, cz.ondrejvane.griphub.domain.Boulder.class.getName() + ".walls");
            createCache(cm, cz.ondrejvane.griphub.domain.Boulder.class.getName() + ".climbs");
            createCache(cm, cz.ondrejvane.griphub.domain.Climb.class.getName());
